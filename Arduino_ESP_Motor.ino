...
void motor_forward() {                      //Function to move our motor forward
...
void motor_backwards() {                    //Function to move our motor forward
...
void motor_stop() {                         //Function to move our motor forward
